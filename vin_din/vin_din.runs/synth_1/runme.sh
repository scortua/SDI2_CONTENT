...
HD_PWD='C:/Users/Scort/OneDrive/Documentos/santiago cortes tovar/trabajos/quinto semestre/SDI-2/vin_din/vin_din.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log visualizador.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source visualizador.tcl
