...
HD_PWD='C:/Users/Scort/OneDrive/Documentos/santiago cortes tovar/trabajos/quinto semestre/SDI-2/vin_din/vin_din.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log visualizador.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source visualizador.tcl -notrace
