...
HD_PWD='C:/Users/Scort/OneDrive/Documentos/santiago cortes tovar/trabajos/quinto semestre/SDI-2/RAM_/MEMORY_RAM/MEMORY_RAM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ram.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ram.tcl -notrace
