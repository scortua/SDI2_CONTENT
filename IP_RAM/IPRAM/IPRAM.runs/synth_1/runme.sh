...
HD_PWD='C:/Users/Scort/Downloads/IPRAM/IPRAM/IPRAM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log IPRAM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source IPRAM.tcl
