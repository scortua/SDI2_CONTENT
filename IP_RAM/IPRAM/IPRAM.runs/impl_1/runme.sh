...
HD_PWD='C:/Users/Scort/Downloads/IPRAM/IPRAM/IPRAM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log IPRAM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source IPRAM.tcl -notrace
